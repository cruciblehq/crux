...
// Parses a version constraint string and fatally fails the test if it returns an error.
...
// Checks whether a version string matches a constraint and fatally fails the test on error.
