...
func TestWatch_Create(t *testing.T) {
	...
	got := make(chan *WatchEvent, 10)

	w, err := Watch(dir, func(e *WatchEvent) error {
		got <- e
		return nil
	})
	if err != nil {
...
func TestWatch_NonexistentPath(t *testing.T) {
	_, err := Watch("/doesnotexist/path", func(e *WatchEvent) error {
		return nil
	})
	if err == nil {
...
func TestWatchRecursive_Success(t *testing.T) {
	...
	w, err := WatchRecursive(dir, func(e *WatchEvent) error {
		got <- e
		return nil
	})
	if err != nil {
...
func TestWatchAll_Success(t *testing.T) {
	...
	w, err := WatchAll([]string{dir1, dir2}, func(e *WatchEvent) error {
		got <- e
		return nil
	})
	if err != nil {
...
func TestWatchAll_PartialFailure(t *testing.T) {
	...
	_, err := WatchAll([]string{dir, "/nonexistent/path"}, func(e *WatchEvent) error {
		return nil
	})
	if err == nil {
...
func TestWatcher_Add(t *testing.T) {
	...
	w, err := Watch(dir1, func(e *WatchEvent) error {
		got <- e
		return nil
	})
	if err != nil {
...
func TestWatcher_AddRecursive(t *testing.T) {
	...
	w, err := Watch(watchDir, func(e *WatchEvent) error {
		got <- e
		return nil
	})
	if err != nil {
