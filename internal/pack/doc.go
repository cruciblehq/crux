...
// manifest (crucible.yaml) and build artifacts from the build/ directory.
...
//	    Dist:          "build",
//	    PackageOutput: "dist/package.tar.zst",
//	}); err != nil {
//	    return err
//	}
//
// The resulting dist/package.tar.zst file contains the complete resource and can
