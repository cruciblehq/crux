...
//
// Matches [a-zA-Z_0-9]. Dots are not permitted. The leading '$' is not part of
// the variable name and is not considered here since it is consumed separately.
