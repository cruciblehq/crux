...
// Represents a Linux capability that can be assigned to a process.
//
// Capabilities are a Linux feature that provide fine-grained control over the
// privileges of processes. They allow processes to have specific capabilities
// without granting them full root privileges. The capabilities listed here are
// based on the Linux's capability set.
type Cap string
...
//
// The shared catalog stores capabilities in their lowercase short form (e.g.
...
func NormalizeCap(c Cap) string {
