...
func TestWatchRecursiveSuccess(t *testing.T) {
	dir := t.TempDir()
...
func TestWatchAllSuccess(t *testing.T) {
	dir1 := t.TempDir()
	dir2 := t.TempDir()
...
func TestWatchAllPartialFailure(t *testing.T) {
	dir := t.TempDir()
...
func TestWatcherRemoveAll(t *testing.T) {
	dir1 := t.TempDir()
	dir2 := t.TempDir()
...
func TestCollectDirsSuccess(t *testing.T) {
	dir := t.TempDir()
...
func TestCollectDirsNonexistentPath(t *testing.T) {
...
func TestWatcherAddAllRollback(t *testing.T) {
	dir1 := t.TempDir()
	dir2 := t.TempDir()
...
func TestWatcherRemoveAllPartialFailure(t *testing.T) {
	dir := t.TempDir()
