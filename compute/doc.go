...
//
// Provider implementations live in sub-packages (e.g. compute/local)
// and are adapted to the compute model by shims that live in this package.
//
// Backend methods are synchronous: they block until the underlying host
...
//
// Provisioning assigns a name to the new host. If provisioning fails,
// the provider tears down any partial state automatically.
//
