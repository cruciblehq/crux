...
var (
	...
	ErrEnvironmentExists                 = errors.New("environment already registered")
	...
	ErrMissingComputeProvider            = errors.New("compute has no provider set")
	ErrInvalidComputeType                = errors.New("invalid compute provider type")
	ErrMissingComputeHost                = errors.New("local compute missing host")
	ErrMissingComputeInstanceType        = errors.New("compute missing instance type")
	...
	ErrMissingDeploymentNetwork          = errors.New("deployment missing network")
	ErrUnresolvedDeploymentService       = errors.New("deployment references unknown service")
	ErrUnresolvedDeploymentContainer     = errors.New("deployment references unknown container")
	ErrUnresolvedDeploymentCompute       = errors.New("deployment references unknown compute")
	ErrUnresolvedDeploymentNetwork       = errors.New("deployment references unknown network")
	ErrUnresolvedDeploymentEnvironment   = errors.New("deployment references unknown environment")
