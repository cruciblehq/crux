...
type Environment struct {
	ID        string            `json:"id"`        // Unique identifier for this environment (e.g. "production", "staging").
	Variables map[string]string `json:"variables"` // Key-value pairs for this environment.
}
